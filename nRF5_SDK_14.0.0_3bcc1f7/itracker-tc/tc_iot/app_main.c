...
//extern void sensor_collect_timer_handle();
...
void do_sim_data_change(void) {
    ...
    g_tc_iot_device_local_data.temp += 1;
    g_tc_iot_device_local_data.temp > 500?-100:g_tc_iot_device_local_data.temp;

    g_tc_iot_device_local_data.humidity += 1;
    g_tc_iot_device_local_data.humidity > 100?0:g_tc_iot_device_local_data.humidity;

    g_tc_iot_device_local_data.light += 1;
    g_tc_iot_device_local_data.light > 4096?0:g_tc_iot_device_local_data.light;

    g_tc_iot_device_local_data.latitude += 1;
    g_tc_iot_device_local_data.latitude > 360?0:g_tc_iot_device_local_data.latitude;

    g_tc_iot_device_local_data.longitude += 1;
    g_tc_iot_device_local_data.longitude > 360?0:g_tc_iot_device_local_data.longitude;
...
void do_rel_data_change(void) {
    TC_IOT_LOG_TRACE("rel data change.");

    g_tc_iot_device_local_data.temp = tracker_data.temp_value;
    g_tc_iot_device_local_data.temp > 500?-100:g_tc_iot_device_local_data.temp;

    g_tc_iot_device_local_data.humidity = tracker_data.humidity_value;
    g_tc_iot_device_local_data.humidity > 100?0:g_tc_iot_device_local_data.humidity;

    g_tc_iot_device_local_data.light = tracker_data.light_value;
    g_tc_iot_device_local_data.light > 4096?0:g_tc_iot_device_local_data.light;

    g_tc_iot_device_local_data.latitude = tracker_data.latitude;
    g_tc_iot_device_local_data.latitude > 360?0:g_tc_iot_device_local_data.latitude;

    g_tc_iot_device_local_data.longitude = tracker_data.longitude;
    g_tc_iot_device_local_data.longitude > 360?0:g_tc_iot_device_local_data.longitude;
